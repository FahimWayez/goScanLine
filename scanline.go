...
func assign(src string, dest any) error {
	...
	case *int8:
		var v int64
		if err := parseInt(src, 8, &v); err != nil {
			return err
		}
		*d = int8(v)
		return nil
	...
	case *int16:
		var v int64
		if err := parseInt(src, 16, &v); err != nil {
			return err
		}
		*d = int16(v)
		return nil
	...
	case *int32:
		var v int64
		if err := parseInt(src, 32, &v); err != nil {
			return err
		}
		*d = int32(v)
		return nil
	...
	case *uint8:
		var v uint64
		if err := parseUint(src, 8, &v); err != nil {
			return err
		}
		*d = uint8(v)
		return nil
	...
	case *uint16:
		var v uint64
		if err := parseUint(src, 16, &v); err != nil {
			return err
		}
		*d = uint16(v)
		return nil
	...
	case *uint32:
		var v uint64
		if err := parseUint(src, 32, &v); err != nil {
			return err
		}
		*d = uint32(v)
		return nil
